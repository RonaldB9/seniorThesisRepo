    ...
    const portRoadMappings = [
        ...
        // 3:1 Port at top-right  
        {
            roadSegments: [
                ...
                { x: 240, y: -140, rotation: 0 }
            ]
        },
        // 3:1 Port at bottom-middle
        {
            roadSegments: [
                { x: 20, y: 260, rotation: -60 },
                { x: 60, y: 240, rotation: 0 }
            ]
        },
        // 3:1 Port at middle-left
        {
            roadSegments: [
                { x: -260, y: 115, rotation: -30 },
                { x: -260, y: 80, rotation: 30 }
            ]
        },
        // 2:1 Brick Port at top-left
        {
            roadSegments: [
                { x: -180, y: -235, rotation: 0 },
                { x: -145, y: -250, rotation: -60 }
            ]
        },
        // 2:1 Sheep Port at middle-right
        {
            roadSegments: [
                { x: 320, y: -10, rotation: -50 },
                { x: 320, y: 20, rotation: 50 }
            ]
        },
        // 2:1 Stone Port at left
        {
            roadSegments: [
                { x: -260, y: -105, rotation: 30 },
                { x: -260, y: -70, rotation: -30 }
            ]
        },
        // 2:1 Wood Port at bottom-left
        {
            roadSegments: [
                { x: -185, y: 240, rotation: 0 },
                { x: -145, y: 265, rotation: 50 }
            ]
        },
        // 2:1 Wheat Port at bottom-right
        {
            roadSegments: [
                { x: 240, y: 150, rotation: 0 },
                { x: 200, y: 170, rotation: -60 }
            ]
        }
    ];
