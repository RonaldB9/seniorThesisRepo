...
function Scoreboard({ allPlayers, userId, currentTurnUserId, largestArmyPlayer, longestRoadPlayer }) {
  return (
    <div className="scoreboard">
      ...
      {allPlayers.map((player) => (
        ...
        >
          ...
          {/* Show Longest Road indicator */}
          {longestRoadPlayer === player.userId && (
            <div className="longest-road-badge">
              🛣️ Longest Road
            </div>
          )}
